            ...
            <div id="div3">
                <div id="div_photo">
                    <table>
                        ...
                        <tr><td><h1 id="h1"><?php echo $nam ;?></h1></td></tr>
                        <tr><td><h1 id="h2"><?php echo $prof ;?> </h1></td></tr>
                    </table>
            ...
            <div id="div4">
                <div id="div_contact">
                    <table style=" margin-top: 25px; margin-left: 25px;">
                        ...
                        <tr><td></td><td id="h5">471/1 Somiti Building, Mirpur Kazipara, Dhaka</td></tr>
                    </table>
                </div>
                <div id="div_education">
                    <table style=" margin-top: 25px; margin-left: 25px;">
                        <tr>
                            ...
                            <!-- for icon -->
                            <td><h2 id="h3">EDUCATION</h2></td></tr>
                        <tr><td colspan="2"><hr size="2" width="100%" color="white"></td></tr>
                        <tr>
                            <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" color="white" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" /><path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" /></svg></td>
                            <td id="h6">2019 - Present</td>
                        </tr>
                        <tr><td></td><td id="h6">Bachelor Of Computer Science.</td></tr>
                        <tr><td></td><td id="h7"><?php echo $university ;?></td></tr>
                        <tr>
                            <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" color="white" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" /><path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" /></svg></td>
                            <td id="h6">2015 - 2017</td></tr>
                        <tr><td></td><td id="h6">Science</td></tr>
                        <tr><td></td><td id="h7"><?php echo $collage ;?></td></tr>
                        <tr>
                            <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" color="white" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" /><path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" /></svg></td>
                            <td id="h6">2009 - 2015</td></tr>
                        <tr><td></td><td id="h6">Science</td></tr>
                        <tr><td></td><td id="h7"><?php echo $school ;?></td></tr>
                    </table>
                </div>
                <div id="div_language">
                    <table style=" margin-top: 25px; margin-left: 25px;">
                        <tr>
                            ...
                            <!-- for icon -->
                            <td><h2 id="h3">LANGUAGE</h2></td>
                        </tr>
                        <tr><td colspan="2"><hr size="2" width="100%" color="white"></td></tr>
                        <ul>
                            <tr><td id="h8">Bangla</td><td> <progress id="h8" value="95" max="100"> 95% </progress></td></tr>
                            <tr><td id="h8">English</td><td> <progress id="h8" value="50" max="100"> 50% </progress></td></tr>
                            <tr><td id="h8">Arabic</td><td> <progress id="h8" value="30" max="100"> 30% </progress></td></tr>
                        </ul>
                    </table>
                </div>
                ...
                <div id="div_profil">
                    <table style=" margin-left: 25px;">
                        <tr>
                            ...
                            <!-- for icon -->
                            <td><h2 id="h9">PROFILE INFO</h2></td>
                        </tr>
                    </table>
                ...
                <div id="div_skill">
                    <table style=" margin-left: 25px;">
                        <tr>
                            ...
                            <!-- for icon -->
                            <td><h2 id="h9">MY SKILLS & EXPERTISE</h2></td>
                        </tr>
                    </table>
                        <hr size="2" width="90%" color="black">
                            ...
                            <b>
                                <tr><td><i>Photoshop</i></td> <td><progress id="h8" value="90" max="100"> 90% </progress></td><td><i>WordPress</i></td> <td><progress id="h8" value="95" max="100"> 95% </progress></td></tr>
                                <tr><td><i>Illustrator</i></td><td><progress id="h8" value="80" max="100"> 80% </progress></td><td><i>inDesign</i></td> <td><progress id="h8" value="80" max="100"> 85% </progress></td></tr>
                                <tr><td><i>MS Office</i></td><td><progress id="h8" value="100" max="100"> 100% </progress></td><td><i>HTML/CSS</i></td> <td><progress id="h8" value="70" max="100"> 70% </progress></td></tr>
                                </b>
                            </table>
                ...
                <div id="div_expreience">
                    ...
                    <table style=" margin-left: 25px;">
                        ...
                        <td><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color="cornflowerblue" fill="currentColor" class="bi bi-briefcase-fill" viewBox="0 0 16 16"><path d="M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v1.384l7.614 2.03a1.5 1.5 0 0 0 .772 0L16 5.884V4.5A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1h-3zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5z"/><path d="M0 12.5A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5V6.85L8.129 8.947a.5.5 0 0 1-.258 0L0 6.85v5.65z"/></svg></td>
                            <!-- for icon -->
                            <td><h2 id="h9">WORK EXPERIENCE</h2></td>
                        </tr>
                    </table>
                        <hr size="2" width="90%" color="black">
                    <table style=" margin-left: 25px;">
                        <tr>
                            ...
                            <td id="h10">2017-2020</td>
                        </tr>
                        <tr><td></td><td id="h10"><?php echo $ex1 ;?></td></tr>
                        <tr><td></td><td id="h11"><i>ABCD TECH BD</i></td></tr>
                        <br>
                        <tr>
                            <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" color="cornflowerblue" fill="currentColor" class="bi bi-gem" viewBox="0 0 16 16"><path d="M3.1.7a.5.5 0 0 1 .4-.2h9a.5.5 0 0 1 .4.2l2.976 3.974c.149.185.156.45.01.644L8.4 15.3a.5.5 0 0 1-.8 0L.1 5.3a.5.5 0 0 1 0-.6l3-4zm11.386 3.785-1.806-2.41-.776 2.413 2.582-.003zm-3.633.004.961-2.989H4.186l.963 2.995 5.704-.006zM5.47 5.495 8 13.366l2.532-7.876-5.062.005zm-1.371-.999-.78-2.422-1.818 2.425 2.598-.003zM1.499 5.5l5.113 6.817-2.192-6.82L1.5 5.5zm7.889 6.817 5.123-6.83-2.928.002-2.195 6.828z"/></svg></td>
                            <td id="h10">2012-2016</td></tr>
                        <tr><td></td><td id="h10"><?php echo $ex2 ;?></td></tr>
                        <tr><td></td><td id="h11"><i>STUV Soft Tech</i></td></tr>
                        <br>
                        <tr>
                        <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" color="cornflowerblue" fill="currentColor" class="bi bi-gem" viewBox="0 0 16 16"><path d="M3.1.7a.5.5 0 0 1 .4-.2h9a.5.5 0 0 1 .4.2l2.976 3.974c.149.185.156.45.01.644L8.4 15.3a.5.5 0 0 1-.8 0L.1 5.3a.5.5 0 0 1 0-.6l3-4zm11.386 3.785-1.806-2.41-.776 2.413 2.582-.003zm-3.633.004.961-2.989H4.186l.963 2.995 5.704-.006zM5.47 5.495 8 13.366l2.532-7.876-5.062.005zm-1.371-.999-.78-2.422-1.818 2.425 2.598-.003zM1.499 5.5l5.113 6.817-2.192-6.82L1.5 5.5zm7.889 6.817 5.123-6.83-2.928.002-2.195 6.828z"/></svg></td>
                            <td id="h10">2007-2011</td></tr>
                        <tr><td></td><td id="h10"><?php echo $ex3 ;?></td></tr>
                        <tr><td></td><td id="h11"><i>IJKL Tech Limited</i></td></tr>
                    </table>
